...
func TestDeleteShortUrl(t *testing.T) {
	...
	resp, err := urls.DeleteShortUrl(req)

	assert.Nil(err)
	assert.Equal(http.NoContent, resp.GetStatusCode())
	assert.Equal("", resp.GetBody())
...
func TestDeleteWithNotFoundUrl(t *testing.T) {
	assert := testAssert.New(t)
...
func TestDeleteWithDispatchError(t *testing.T) {
	assert := testAssert.New(t)
...
func TestDeleteWithRepositoryError(t *testing.T) {
	assert := testAssert.New(t)
...
func TestDeleteWithEmptyUrl(t *testing.T) {
	assert := testAssert.New(t)
